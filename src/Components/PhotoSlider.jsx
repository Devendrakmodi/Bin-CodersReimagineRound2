...
const PhotoSlider = () => {
    ...
    mm.add("(max-width: 500px)", () => {
      gsap.to(photoSilderConRef.current, {
        ...
        scrollTrigger: {
          ...
          scrub: true,
          start: "top top",
          end: () => "+=" + photoSliderRef.current.offsetWidth,
          // invalidateOnRefresh: true,
        },
      });
    });

    mm.add("(min-width: 501px) and (max-width: 768px)", () => {
      gsap.to(photoSilderConRef.current, {
        x: "-800vw",
        duration: 1,
        ease: "none",
  ...
  return (
    <div
      ref={photoSliderRef}
      className="photoslider w-full min-h-screen overflow-hidden relative pointer-events-[all]"
    >
      <canvas
        ref={canvasRef}
        className="hidden 350px:inline-block absolute inset-0 h-full w-screen"
      />
      <div
        ref={photoSilderConRef}
        className={`photoslider-container max-650px:translate-x-[100vw] w-[800vw] md:w-[400vw] h-full flex justify-start items-center  relative`}
      >
        {carCardDetails.map((carCard, index) => (
          <div
            key={index}
            className="car-card-container w-fit lg:w-screen h-full flex justify-center items-center lg:gap-5 px-10 my-5 lg:py-20 "
          >
            <div className="max-lg:px-2 w-screen h-[300px] 600px:w-[580px] 600px:h-[400px] bg-[#ffffff33] backdrop-blur-[2px] border mx-10 lg:mx-0 xl:mx-10 p-2 bg-[conic-gradient(#ff4191,#ffb200,#006aff,#e90074,#ff4191)]">
            ...
            <div className="max-lg:px-4 w-screen h-[90vh] 600px:h-[500px] 600px:w-[580px] bg-[#cc9d9a19] backdrop-blur-[12px] border rounded-md mx-10 lg:mx-0 xl:mx-10 flex justify-between gap-5 flex-col px-5 py-8 font-Basel_Grotesk">
              <div className="car-modal z-10 flex items-center mb-3 text-2xl 1070px:text-3xl font-semibold font-Gustavo max-lg:flex-col">
                <span
                ...
                <div className="inline z-10 max-lg:text-center">
                  {carCard.modalName}
                </div>
              </div>
